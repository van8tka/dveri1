...
namespace Domain2.Interfaces
{
    public interface IMegkomnatnyeDvRepository
    {
       ...
       MegkomnatnyeDveri GetMkDvById(int id);
        void CreateMkDv(int id, string naz, string pr, string strpr, int? cvet, string material, string pokryt, string karkas, string typdv, string vnytrnapoln, decimal? cena, int? skidka, decimal? csskid, string opis, bool publ, string dopchar);
